...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (input == '\t') {  // Tab character
                String partialCommand = currentInput.toString().trim();
                String completedCommand = autocomplete(partialCommand);
                if (completedCommand != null) {
                    System.out.print("\r$ " + completedCommand);  // Clear line and print completed command
                    currentInput = new StringBuilder(completedCommand);
                }
                continue;
            }
            ...
            if (input == '\n') {  // Enter key
                ...
                LineParser parser = new LineParser(commandLine);
                ...
                System.out.print("$ ");
            } else if (input != -1) {  // Regular character input
                currentInput.append((char)input);
            }
        }
    }
